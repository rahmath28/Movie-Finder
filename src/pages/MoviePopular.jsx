...
const MoviePopular = () => {
  ...
  useEffect(() =>{ 
   const fetchMovies = async()=>{
      const response = await fetch("https://api.themoviedb.org/3/movie/popular?language=en-US&page=1", options); // options is my bearer authetication token, passed top rated CATEGORY URL.
      const data = await response.json();
      // console.log(data) // got data of whole details. , results variable holds the Full array of all movies.
